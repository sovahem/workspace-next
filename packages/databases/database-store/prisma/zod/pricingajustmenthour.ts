...
export interface CompletePricingAdjustmentHour
  extends z.infer<typeof PricingAdjustmentHourModel> {
 ...
 */
export const RelatedPricingAdjustmentHourModel: z.ZodSchema<CompletePricingAdjustmentHour> =
  z.lazy(() =>
    PricingAdjustmentHourModel.extend({

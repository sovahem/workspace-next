...
import { CompletePricingAdjustmentHour, RelatedPricingAdjustmentHourModel, CompletePricingAdjustmentSpecificDate, RelatedPricingAdjustmentSpecificDateModel, CompleteProductPricingAdjustment, RelatedProductPricingAdjustmentModel } from "./index"
...
export interface CompletePricingAdjustment extends z.infer<typeof PricingAdjustmentModel> {
 ...
 */
export const RelatedPricingAdjustmentModel: z.ZodSchema<CompletePricingAdjustment> = z.lazy(() => PricingAdjustmentModel.extend({

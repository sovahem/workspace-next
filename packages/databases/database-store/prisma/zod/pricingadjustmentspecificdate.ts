...
export interface CompletePricingAdjustmentSpecificDate extends z.infer<typeof PricingAdjustmentSpecificDateModel> {
 ...
 */
export const RelatedPricingAdjustmentSpecificDateModel: z.ZodSchema<CompletePricingAdjustmentSpecificDate> = z.lazy(() => PricingAdjustmentSpecificDateModel.extend({
